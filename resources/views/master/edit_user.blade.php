                                ...
                                <form method="POST" action="/edit_user">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            value="{{ empty(old('first_name')) ? ($user->first_name) : old('first_name')}}" required autocomplete="first_name" autofocus>
                                            @error('first_name')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            value="{{ empty(old('last_name')) ? ($user->last_name) : old('last_name')}}" required autocomplete="last_name" autofocus>  
                                            @error('last_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 mt-1">
                                            ...
                                            value="{{ empty(old('full_name')) ? ($user->full_name) : old('full_name')}}" required autocomplete="full_name" autofocus>  
                                            @error('full_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2 mt-1">
                                            ...
                                            value="{{ empty(old('age')) ? ($user->age) : old('age')}}" required autocomplete="age" autofocus>  
                                            @error('age')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 mt-1">
                                            <label>
                                                <input class="@error('school_id') is-invalid @enderror" 
                                                type="radio" name="school_id" value=1 checked="checked" @if(old('school_id')==1) checked @endif>本校
                                            </label>
                                            <label>
                                                <input class="@error('school_id') is-invalid @enderror" 
                                                type="radio" name="school_id" value=2 @if(old('school_id')==2) checked @endif>２校
                                            </label>
                                        </div>
                                        ...
                                        <div class="col-md-6 mt-1">
                                            <label>
                                                <input class="@error('school_id') is-invalid @enderror" 
                                                type="radio" name="school_id" value=1  @if(old('school_id')==1) checked @endif>本校
                                            </label>
                                            <label>
                                                <input class="@error('school_id') is-invalid @enderror" 
                                                type="radio" name="school_id" value=2 checked="checked" @if(old('school_id')==2) checked @endif>２校
                                            </label>
                                        </div>
                                        @endif
                                    </div>
