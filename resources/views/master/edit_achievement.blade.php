            ...
            <div class="row justify-content-center">
                <div class="card-body">
                    <form method="POST" action="/edit_achievement">
                            ...
                            <div class="col-md-6 mt-1">
                                <label class="mr-3">
                                    <input class="@error('medical_support') is-invalid @enderror" type="radio"
                                        name="medical_support" value=0 @if($achievement->medical_support==0) checked @endif
                                        required autocomplete="medical_support" autofocus>無
                                </label>
                                <label>
                                    <input class="@error('medical_support') is-invalid @enderror" type="radio"
                                        name="medical_support" value=2 @if($achievement->medical_support==2)  checked @endif
                        ...
                        <div class="form-group row">
                            <label for="medical_support" class="col-md-5 col-form-label text-md-right">備考</label>
